(() => {
          ...
          if (Array.isArray(material2)) {
            ...
            for (let k = 0, kl = groups.length; k < kl; k++) {
              ...
              if (groupMaterial && groupMaterial.visible) {
                ...
                object.onBeforeShadow(_renderer, object, camera2, shadowCamera, geometry2, depthMaterial, group);
                _renderer.renderBufferDirect(shadowCamera, null, geometry2, depthMaterial, object, group);
                object.onAfterShadow(_renderer, object, camera2, shadowCamera, geometry2, depthMaterial, group);
              }
            }
          } else if (material2.visible) {
            const depthMaterial = getDepthMaterial(object, material2, light, type);
            object.onBeforeShadow(_renderer, object, camera2, shadowCamera, geometry2, depthMaterial, null);
            _renderer.renderBufferDirect(shadowCamera, null, geometry2, depthMaterial, object, null);
            object.onAfterShadow(_renderer, object, camera2, shadowCamera, geometry2, depthMaterial, null);
          }
        }
      }
      const children = object.children;
  ...
  var material = new MeshStandardMaterial({ color: 8947848 });
  var cube = new Mesh(geometry, material);
  scene.add(cube);
  var directionalLight = new DirectionalLight(16777215, 1);
