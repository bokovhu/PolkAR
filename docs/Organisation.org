...
- [ ] switch to mono structure

** [#B] Tuesday
- [ ] Create Cube with Hologram Picture
- [ ] Create Cube with Hologram powered by Chip Picture
...
- [ ] make pitch deck
  ...
  - [ ] write conculstion
- [ ] make buisness plan
  - [ ] write one page of buisness plan
  - [ ] read 6 page memo layout
- [ ] send it to klara
- [ ] insert picture of pcs
